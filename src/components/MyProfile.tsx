...
const MyProfile = ({
  ...
  const [myProfileContainerHeight, setMyProfileContainerHeight] = useState(0);

  useEffect(() => {
    const getMyProfileContainerHeight = (): number => {
    ...
    const myProfileContainerHeight = getMyProfileContainerHeight();
    setMyProfileContainerHeight(myProfileContainerHeight);
  }, [myProfileContainerHeight]);

  console.log("myProfileContainerHeight", myProfileContainerHeight);

  return (
    <MyProfileContainerStyle
      id="my-profile"
      backgroundColor={backgroundColor}
      myProfileContainerHeight={myProfileContainerHeight}
    >
      <Flex
        direction="column"
        justify="center"
            ...
            <ListRow
              contents={
                <Flex direction="column" gap={16}>
                  <div>
                    <Badge as="span" label="010-1234-5678" />
                  </div>
                  <div>
                    <Badge as="span" label="test1234@naver.com" />
                  </div>
                </Flex>
              }
            />
...
const MyProfileContainerStyle = styled.section<{
  backgroundColor: string;
  myProfileContainerHeight: number;
}>`
  display: flex;
  ...
  width: 100%;
  height: ${({ myProfileContainerHeight }) => myProfileContainerHeight}px;
`;
